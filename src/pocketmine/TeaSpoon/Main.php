...
class Main extends PluginBase {
	...
	public const BASE_POCKETMINE_VERSION = "1.0dev"; // The PocketMine version before Jenkins builds it... (Can be found on PocketMine.php as the 'VERSION' constant)
	public const TESTED_MIN_POCKETMINE_VERSION = ""; // The minimum build this was tested working
	public const TESTED_MAX_POCKETMINE_VERSION = ""; // The current build this was actually tested
	...
	private function checkServer() : bool {
		if(Utils::isServerPhared()){
			$serverVersion = $this->getServer()->getLikeMPVersion();
